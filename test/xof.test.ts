...
test("crypto_xof_turboshake128 init_with_domain", () => {
    ...
    const out_standard = sodium.crypto_xof_turboshake128_squeeze(state_standard, 32);
...
test("crypto_xof_turboshake256 init_with_domain", () => {
    ...
    const out_standard = sodium.crypto_xof_turboshake256_squeeze(state_standard, 32);
