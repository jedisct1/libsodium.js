...
test("crypto_sign", () => {
	...
	const verified2 = sodium.crypto_sign_verify_detached(
		signature,
		message,
		publicKey,
	);
	...
	const message2 = sodium.from_string(
		"Science, math, technology, engineering, and compassion for others. XYZ",
	);
	const verified3 = sodium.crypto_sign_verify_detached(
		signature,
		message2,
		publicKey,
	);
...
test("crypto_sign_ed25519_to_curve25519", () => {
	const secretkey = sodium.from_hex(
