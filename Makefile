...
sumo: $(MODULES_SUMO_DIR)/libsodium-wrappers-sumo.js $(MODULES_SUMO_DIR)/libsodium.js
...
$(MODULES_SUMO_DIR)/libsodium-wrappers-sumo.js: wrapper/build-wrappers.js wrapper/build-doc.js wrapper/wrap-template.js
