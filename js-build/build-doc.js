...
docStr += '* outputFormat : A string indicating in which output format you want the result to be returned. Supported values are "uint8array", "text", "hex", "base64". Optional parameter. Not available on all functions. Defaults to uint8array. Note that you can change the default encoding by calling `libsodium.set_encoding(encodingName)`' + newParagraph();
